...
/////////////////////////////
    ...
    handle(action1, action2) {
        ...
        if (this.hardwareOn && (this.socket.readyState === 1)) {
            let left = (forceLeft * 0.6).toFixed(0);
            let right = (forceRight * 0.6).toFixed(0);
...
Car.Sensors = (() => {
    ...
    return sensors.SensorBlueprint.compile([
        ...
        { type: 'distance', angle: -75, length: 1.5, start: [ 0-0.18, t-0.08 ],  index: 0, contactKoeff: 0.2},
        { type: 'distance', angle: -45, length: 2.5, start: [ 0-0.13, t-0.04 ], index: 1, contactKoeff: 0.5},
        ...
        { type: 'distance', angle: +45, length: 2.5, start: [ 0+0.13, t-0.04 ], index: 4, contactKoeff: 0.5},
        { type: 'distance', angle: +75, length: 1.5, start: [ 0+0.18, t-0.08 ], index: 5, contactKoeff: 0.2},

        { type: 'distance', angle: -105, length: 1.5, start: [ 0-0.18, b+0.08 ], index: 6, contactKoeff: 0.2},
        { type: 'distance', angle: -135, length: 2.5, start: [ 0-0.13, b+0.04 ], index: 7, contactKoeff: 0.5},
        { type: 'distance', angle: -165, length: 5.5, start: [ 0-0.05, b ], index: 8, contactKoeff: 1.0},
        { type: 'distance', angle: +165, length: 5.5, start: [ 0+0.05, b ], index: 9, contactKoeff: 1.0},
        { type: 'distance', angle: +135, length: 2.5, start: [ 0+0.13, b+0.04 ], index: 10, contactKoeff: 0.5},
        { type: 'distance', angle: +105, length: 1.5, start: [ 0+0.18, b+0.08 ], index: 11, contactKoeff: 0.2},
